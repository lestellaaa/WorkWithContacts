...
namespace UnitTestProject1
{
    ...
    public class UnitTestForContact
    {
        ...
        [TestMethod]
        public void Contact_Norm2()
        {
            var contact = new Contact("Иван Иванович", "89991234569");
            Assert.AreEqual("Иван Иванович", contact.Name);
            Assert.AreEqual("89991234569", contact.PhoneNumber);
        }
